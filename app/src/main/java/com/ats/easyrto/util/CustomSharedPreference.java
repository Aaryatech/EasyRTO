...
public class CustomSharedPreference {
    ...
    private static String PREFERENCE_NAME = "EasyRTO_Pref";

    public static String KEY_CUSTOMER = "Customer";

    public static String KEY_HEADER = "Header";
    public static String KEY_PATH_ARRAY = "PathArray";
    public static String KEY_FILE_NAME_ARRAY = "FileNameArray";
    public static String KEY_TYPE = "Type";
    public static String KEY_WORK_TYPE = "WorkType";
